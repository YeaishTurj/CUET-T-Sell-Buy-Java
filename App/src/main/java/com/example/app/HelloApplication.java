...
public class HelloApplication extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        Font font=Font.loadFont(Objects.requireNonNull(HelloApplication.class.getResource("/fonts/MontaguSlab.ttf")).toExternalForm(), 64);
        ...
        // Load FXML
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("item_screen.fxml"));
